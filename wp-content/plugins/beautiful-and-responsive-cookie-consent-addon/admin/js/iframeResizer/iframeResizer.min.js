...
!(function (l) {
  ...
  function n(n) {
    ...
    function r(e) {
      ...
      return (
        S(v),
        { x: Math.floor(Number(n.left) + Number(k.x)), y: Math.floor(Number(n.top) + Number(k.y)) }
      );
    }
    function o(e) {
      ...
      : ((d = (d = e) || {}),
        ...
        F[c] &&
          (F[c].targetOrigin =
            !0 === F[c].checkOrigin
              ? (function (e) {
                  return "" === e || null !== e.match(/^(about:blank|javascript:|file:\/\/)/)
                    ? "*"
                    : e;
                })(F[c].remoteHost)
              : "*"),
        (function () {
          switch (
            (T(
              c,
              "IFrame scrolling " + (F[c] && F[c].scrolling ? "enabled" : "disabled") + " for " + c
            ),
