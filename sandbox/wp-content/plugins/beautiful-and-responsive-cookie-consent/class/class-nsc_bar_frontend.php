...
class nsc_bar_frontend
{
    ...
    public function nsc_bar_get_dataLayer_banner_init_script($returnValue)
    {
        ...
        if (empty($returnValue)) {
            ...
            echo '!function(){const e=' . json_encode($this->escape_cookies($cookies)) . ' || {},i="' . esc_js($this->dataLayerName) . '" || "dataLayer",o=Object.keys(e),t={event:"beautiful_cookie_consent_initialized"};for(let i=0;i<o.length;i++)t[o[i]]=n(o[i])||e[o[i]].defaultValue,"dismiss"===t[o[i]]&&(t[o[i]]="allow");function n(e){const i=`; ${document.cookie}`.split(`; ${e}=`);if(2===i.length)return i.pop().split(";").shift()}window[i]=window[i]||[],window[i].push(t)}();';
            echo "</script>";
            return;
        }
    ...
    {
        // if ('nsc_bar_nice-cookie-consent' === $handle) {
        //     return str_replace("rel=", "nowprocket data-no-optimize='1' rel=", $html);
        // }
        return $html;
    }
    ...
    {
        // if ($handle === 'nsc_bar_nice-cookie-consent_js') {
        //     return str_replace('id=', 'data-cfasync="false" data-pagespeed-no-defer data-cfasync nowprocket data-no-optimize="1" data-no-defer="1" id=', $tag);
        // }
        return $tag;
    }
